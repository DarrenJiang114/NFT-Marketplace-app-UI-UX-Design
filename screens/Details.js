...
const DetailsHeader = ({data, navigation}) => (
    <View style={{width: '100%', height: 373}}>
        ...
        handlePress={() => navigation.goBack()} left={15} top={StatusBar.currentHeight + 10}/>
        <CircleButton imgUrl={assets.heart}
        handlePress={() => navigation.goBack()} right={15} top={StatusBar.currentHeight + 10}/>
    </View>
)
const Details = ({route, navigation}) => {
    ...
    return(
        <SafeAreaView style={{flex: 1, width:'100%', height: '100%', backgroundColor:'white'}}>
            ...
            paddingVertical: SIZES.font, justifyContent: 'center', alignItems: 'center',
            backgroundColor:'rgba(255,255,255,0.5)', zIndex: 1}}>
                <RectButton minWidth={170} fontSizes={SIZES.large} {...SHADOWS.dark}/>
            </View>
